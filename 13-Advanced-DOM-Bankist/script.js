...
// message.innerHTML = `We use cookues for improved functionality and analitics. <button class="btn btn--close--cookies">Got it!</button>`;
...
// logo.alt = `Beautiful munimalist logo`
...
// logo.classList.contains(`c`); // not inclused
...
// // .insertAdjacentHTML - already used

// const message = document.createElement(`div`);
// message.classList.add(`cookie-message`);
// // message.textContent = `We use cookues for improved functionality and analitics.`;
// message.innerHTML = `We use cookues for improved functionality and analitics. <button class="btn btn--close--cookies">Got it!</button>`;

// // dom elements is unique and we can move it by using prepend and append
